...
var Reversi = function () {
  ...
  _createClass(Reversi, [{
    ...
    value: function thisMovesToByteMoves() {
      ...
      var foo = new _bignumber2.default(moves[0], 2);
      var bar = new _bignumber2.default(moves[1], 2);
    ...
    value: function stringMovesToBinaryMoves() {
      ...
      stringMoves = stringMoves.match(/.{1,2}/g).map(function (move) {
        ...
        var foo = new _bignumber2.default(m[0] + m[1] * 8 + 64);
    ...
    value: function binaryBoardToByteBoard(binaryBoard) {
      var foo = new _bignumber2.default(binaryBoard, 2);
    ...
    value: function byteBoardToArrayBoard() {
      ...
      byteBoard = new _bignumber2.default(byteBoard, 16);
    ...
    value: function byteMovesToStringMoves() {
      ...
      byteMoves = new _bignumber2.default(byteMoves, 16);
    ...
    value: function binaryMovesToByteMoves() {
      ...
      var foo = new _bignumber2.default(binaryMoves, 2);
      return foo.toString(16);
    }
  }, {
    ...
    value: function binaryMovesToStringMoves() {
      ...
      binaryMoves = binaryMoves && new _bignumber2.default(binaryMoves, 2);
      ...
      return binaryMoves.match(/.{1,7}/g).map(function (move) {
        move = new _bignumber2.default(move, 2).toNumber(10);
        if (move < 64) {
          return false;
        } else {
          move -= 64;
    ...
    key: 'returnSymmetriesAsBigNumber',
    value: function returnSymmetriesAsBigNumber() {
      var symmetries = new _bignumber2.default(0);
